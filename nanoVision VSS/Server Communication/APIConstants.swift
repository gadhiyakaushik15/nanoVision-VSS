...
struct API {
    ...
    static let authenticationSaveData = viableSoftBaseURL + "/facerecognitionVD/api/v1/face/AuthenticationsaveData"
    static let day = viableSoftBaseURL + "/facerecognitionVD/api/v1/face/day"
    static let locationTable = viableSoftBaseURL + "/facerecognitionVD/api/v1/face/locationtable"
